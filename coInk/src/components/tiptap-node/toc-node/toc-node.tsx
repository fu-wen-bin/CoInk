...
export function TocNodeComponent(props: NodeViewProps) {
  ...
  if (!visibleHeadings.length) {
    return (
      <NodeViewWrapper {...wrapperProps}>
        <div className="tiptap-table-of-contents-empty">添加标题后可自动生成目录。</div>
      </NodeViewWrapper>
    );
  }
  ...
  return (
    <NodeViewWrapper {...wrapperProps}>
      {showTitle && <div className="tiptap-table-of-contents-title">目录</div>}
      <nav aria-label="文档目录" className="tiptap-table-of-contents-list">
