  ...
  return (
    <section className="relative w-full h-full min-h-[calc(100vh-200px)] flex items-center justify-center px-6 py-16 sm:py-24 overflow-hidden bg-gradient-to-b from-white via-white to-slate-50">
      ...
      <div className="pointer-events-none absolute inset-0">
        {/* 柔和渐变光斑 */}
        <div className="absolute -top-24 -left-24 w-[36rem] h-[36rem] rounded-full bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.15),transparent_60%)]" />
        <div className="absolute -bottom-24 -right-24 w-[30rem] h-[30rem] rounded-full bg-[radial-gradient(circle_at_center,rgba(34,197,94,0.12),transparent_60%)]" />
        {/* 细格纹 */}
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto">
        ...
        <div className="relative">
          <div className="absolute -inset-[1px] rounded-2xl bg-gradient-to-r from-emerald-400/30 via-green-400/20 to-teal-400/30 blur-lg" />

          <div className="rounded-2xl border border-slate-200 bg-white p-8 md:p-10 shadow-xl">
            {/* 顶部徽标 */}
            <div className="mb-6 flex items-center justify-center gap-3">
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-600 to-green-600 shadow-lg">
              ...
              <span className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs text-emerald-700">
                <Sparkles className="h-3.5 w-3.5 text-emerald-500" /> 功能开发进行中
              </span>
            </div>

            {/* 标题 */}
            <h1 className="text-center text-4xl md:text-5xl font-extrabold leading-tight tracking-tight">
              <span className="bg-gradient-to-r from-slate-900 via-emerald-700 to-green-600 bg-clip-text text-transparent">
                敬请期待
              </span>
            </h1>
            ...
            <div className="mt-8">
              ...
              <div className="h-2 w-full overflow-hidden rounded-full bg-slate-200">
                <motion.div
                  ...
                  className="h-full rounded-full bg-gradient-to-r from-emerald-500 via-green-500 to-teal-400"
                />
              </div>
            </div>
